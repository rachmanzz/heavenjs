                            ...
                            run: function () {
                                parseURL(uri[1],uri[2],data, function (data, status) {
                                    ...
                                    status == 'success' && forEachModule({
                                        symbol:symbol,
                                        object:typeof module.attr('select-data') != "undefined" && typeof getObjectProp(JSON.parse(data),model.attr('select-data')) ?getObjectProp($.parseJSON(data),model.attr('select-data')): $.parseJSON(data),
                                        html:html,
                                        module:module,
                                        storage:{
                                            number : 1,
